...
import { Bike, Clock, PackageCheck, RefreshCcw, ChevronLeft } from 'lucide-react';
          ...
          <div className=' flex-1 flex flex-col justify-center items-start gap-10'>
            ...
            <div className='flex flex-col gap-6 items-start'>
              <div>
                ...
                <AddToCart price_id={bike.price_id} name={bike.name} currency="USD" images={bike.images} price={bike.price} description={bike.description} btnStyles='btn btn-accent' text='Add to cart'/>
            ...
            <div className='flex flex-col gap-3'>
              ...
              <div className='flex gap-2'>
                ...
                <p>the bikes are partially assembled and benift from transport insurance</p>
              </div>
              <div className='flex gap-2'>
