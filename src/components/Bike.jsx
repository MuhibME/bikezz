...
const Bike = ({bike}) => {
    ...
    return (
    <div className='group'>
        <div className='border h-[330px] mb-5 p-4 overflow-hidden relative'>
            ...
            <div className='absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center gap-[10px] opacity-0 group-hover:opacity-100 transition-all duration-300'>
                <AddToCart price_id={bike.price_id} name={bike.name} currency="USD" images={bike.images} price={bike.price} description={bike.description} btnStyles='btn-icon btn-accent' icon={<CgShoppingBag/>} />
